...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/gymcss/com/UserCart.css?ver=123">
...
<body>
					...
					<div class="row">
						<div class="col-md-9">
							<div class="ibox">
								...
								<c:forEach items="${CartList}" var="com">
									<form action="getRemoveCart.func" method="post">
														...
														<tr>
															<td width="90">
																<div class="cart-product-imitation">
																	<img src="data:image/png;base64,${com.comPicBase64}" name="comPic" class="comPic" style="width: 100%; height: 100%" />
																</div>
															</td>
															<td class="desc">
																<h3>
																	<a href="#" class="text-navy"> ${com.comName} </a>
																</h3>
															...
															<td width="65" height="fit-content"><input
																type="text" class="form-control itemNum"
																value="${com.comNumber}" data-price="${com.comPrice}" /></td>
															<td>
																<h5>$: ${com.comPrice}</h5>
															</td>
														</tr>
										...
										<input type="hidden" name="itemNumber" value="${com.comNumber}">
										<input type="hidden" name="userState" value="removeCartItem">
									</form>
								</c:forEach>

								<div class="ibox-content">
									<a href="${pageContext.request.contextPath}/UserServlet?userState=checkItem">
						...
						<div class="col-md-3">
							<form action="${pageContext.request.contextPath}/UserServlet" method="post">
								...
								<c:forEach items="${CartList}" var="com">
									<input type="hidden" name="comId" value="${com.comId}">
									<input type="hidden" name="itemNum-${com.comId}" id="itemNum-${com.comId}" value="${com.comNumber}">
	...
	<footer class="py-3 my-4">
		<ul class="nav justify-content-center border-bottom pb-3 mb-3">
			...
			<li class="nav-item"><a href="#" class="nav-link px-2 text-muted">常見問題</a></li>
			<li class="nav-item"><a href="#" class="nav-link px-2 text-muted">服務條款</a></li>
			<li class="nav-item"><a href="#" class="nav-link px-2 text-muted">客服中心</a></li>
		</ul>
		<p class="text-center text-muted">© 2023 Oh Gym Gym. All Rights	Reserved.</p>
	</footer>
	...
	<script>
		...
		function scrollFunction() {
			if (document.body.scrollTop > 20
				...
				document.getElementById("back-to-top-btn").classList
						.remove("hide");
			} else {
				document.getElementById("back-to-top-btn").classList
						.add("hide");
				...
				function() {
					...
					$('.itemNum').on(
							...
							function() {
								...
								const comId = $(this).closest('form').find(
										'[name="comId"]').val();
								console.log(comId);
