...
<%@page import="tw.gym.model.forum.ArticleBean"%>
		...
		<div class="container">
			<div class="row">
				<div class="col-6">
					...
					<h1>預覽文章</h1>
					<form action="getAllArticle" method="get">  <!-- enctype="multipart/form-data" -->
						<%
						...
						<div class="form">
							...
							文章編號:
							<div>
								<%=articleBean.getArticleId()%></div>
							<br> 會員編號:
							<div>
								<%=articleBean.getUserId()%></div>
							<br> 主題分類
							<div><%=articleBean.getArticleType()%></div>
							<br> 標題：
							<div><%=articleBean.getArticleTitle()%></div>
							<br>
				...
				<div><img src="<%=dataURI%>" style="width: 100px;"> </div>    
						...
						<br> 文章內容：<br>
						<div><%=articleBean.getArticleContent()%></div>
						<br>
						<br> 時間:<br>
				...
				<button type="button" class="btn btn-dark .text-dark "
					data-bs-toggle="modal" data-bs-target="#publishModal">確定</button>
				<!-- Modal -->
				<div class="modal fade" id="publishModal" data-bs-backdrop="static"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">你確定要發表發文嗎?</div>
				...
				<button type="button" class="btn btn-dark .text-dark"
					data-bs-toggle="modal" data-bs-target="#cancelModal">取消</button>
				...
				<div class="modal fade" id="cancelModal" data-bs-backdrop="static"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">你確定要取消發文嗎?</div>
							<div class="modal-footer">
								<button type="submit" class="btn btn-secondary"
									data-bs-dismiss="modal">取消</button>
								<button type="submit" class="btn btn-dark">確定</button>
