    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
           <c:set var="userLoggedIn" value="${sessionScope.userLoggedIn != null}" />

                <div class="container-fluid">
                    <header>
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="FirstWebPage"><i class="fa fas fa-solid fa-dumbbell"></i> Oh
                                    GymGym</a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="userItemList.func">線上商城</a></li>
                                                <li><a class="dropdown-item" href="#">2</a></li>
                                                <li><a class="dropdown-item" href="#">3</a></li>
                                                <li><a class="dropdown-item" href="#">4</a></li>
                                            </ul>
                                       ...
                                       <c:if test="${sessionScope.userAccount != null}">
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="userDetails.controller">會員專區</a></li>
                                        ...
                                        <a class="navbtn" id="userAreaLink" href="UserArea.jsp">
                                            <img src="${pageContext.request.contextPath}/images/user__icon_new.png" alt="Custom Icon" height="30px"
                                                width="30px">
                                        </a>
                                        </c:when>
   										 <c:otherwise>
                                            <a class="navbtn" id="userAreaLink" href="Login">
                                             <span class="Login">我要登入</span>
                                            </a>
                                            <a class="navbtn" id="userAreaLink" href="Register">
											...
											<c:if test="${sessionScope.userAccount != null}">
                                                <a class="navbtn" href="getIntoCart.func"><img src="${pageContext.request.contextPath}/images/cart_new.jpg"
                                                        alt="Custom Icon" height="30px" width="30px"></a>
                                                <a class="navbtn" href="#" data-toggle="modal"
                                                    data-target="#exampleModal3"><img src="${pageContext.request.contextPath}/images/message_new.png"
                                                        alt="Custom Icon" height="30px" width="30px"></a>
