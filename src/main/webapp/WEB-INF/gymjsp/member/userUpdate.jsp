...
<%@ page import="tw.gym.model.member.Member" %>
...
<body>
    <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="FirstWebPage">會員專區</a></li>
     ...
     <div class="container">
    <form action="userUpdate.controller" method="POST">
        ...
        <table class="table table-bordered mt-4">
            ...
            <tbody>
                <tr>
                    <th>會員編號</th>
                    <td>
                           <input type="hidden" name="userId" value="${sessionScope.userId}" />${sessionScope.userId}
                    </td>
                </tr>
                <tr>
                    <th>帳號</th>
                    <td>
                        <input type="hidden" name="userAccount" value="${sessionScope.userAccount}" />${sessionScope.userAccount}
           			</td>
                ...
                <tr>
                    <th>性別</th>
                    <td>
                        <input type="hidden" name="userGender" value="${sessionScope.userGender}" />${sessionScope.userGender}
                    </td>
                </tr>
                <tr>
                    <th>出生日期</th>
                    <td>
                        <input type="date" name="userBirthDay" value="${sessionScope.userBirthDay}" />
                    </td>
                </tr>
                <tr>
                    <th>地址</th>
                    <td>
                        <input type="text" name="userAddress" value="${sessionScope.userAddress}" />
                    </td>
                </tr>
                <tr>
                    <th>電話</th>
                    <td>
                        <input type="text" name="userTel" value="${sessionScope.userTel}" />
                    </td>
                </tr>
                <tr>
                    <th>信箱</th>
                    <td>
                        <input type="text" name="userEmail" value="${sessionScope.userEmail}" />
                    </td>
                </tr>
                <tr>
                    <th>暱名</th>
        ...
        <div class="button-container">
            <a href="FirstPage" class="btn btn-primary" role="button">取消</a>
