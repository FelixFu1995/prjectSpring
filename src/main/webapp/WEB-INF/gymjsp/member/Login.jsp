    ...
    <div class="container-fluid">
        <header>
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/gymjsp/member/Admin.jsp"><i class="fa fas fa-solid fa-dumbbell"></i> Oh GymGym</a>
        ...
        <div class="container">
            <form class="login-form" action="checkLogin.controller" method="POST">
               ...
               <div class="form-group">
				    ...
				    <span class="error">${errors.acc}</span>
				</div>
				<div class="form-group">
                ...
                <div class="login">
                    <button type="submit" value="Login"class="btn btn-primary btn-login">登入</button>
                </div>
                <div class="mt-2 registration-link">
                    沒有帳號嗎? <a href="Register">註冊</a>
                </div>
