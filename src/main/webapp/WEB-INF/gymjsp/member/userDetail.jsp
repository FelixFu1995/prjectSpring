...
<body>
    <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="FirstWebPage">返回首頁</a></li>
        ...
        <div class="container">
            <form action="${pageContext.request.contextPath}/gymjsp/member/userUpdate.jsp" method="POST">
            <h1 class="mt-5">註冊資訊顯示</h1>
             ...
             <thead>
                ...
                <tr>
                    <th>出生日期</th>
                    <td>
                    	 <%=session.getAttribute("userBirthDay")%>
                    </td>
                </tr>
                <tr> 
                    <th>地址</th>
            ...
            <div class="button-container">
                    <a href="FirstWebPage" class="btn btn-primary" role="button">確定</a>
