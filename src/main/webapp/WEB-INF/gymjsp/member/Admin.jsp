...
<body>
    <div class="container-fluid">
        ...
        <div class="first">
            <ul class="ul">
                <li><a href="https://example.com"><i class="fa-solid fa-dumbbell"></i></a></li>
                <li><a href="https://example.com"><i class="fa-brands fa-shopify"></i></a></li>
                <li><a href="https://example.com"><i class="fa-solid fa-face-smile"></i></a></li>
                <li><a href="https://example.com"><i class="fa-solid fa-comment"></i></a></li>
                <li><a href="https://example.com"><i class="fa-solid fa-user"></i></a></li>
            </ul>
        </div>
